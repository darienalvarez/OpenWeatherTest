 ...
 * DAO for table "ZIP".
*/
public class ZipDao extends AbstractDao<Zip, Long> {

    public static final String TABLENAME = "ZIP";

    /**
     * Properties of entity Zip.<br/>
    ...
    */
    ...
    public ZipDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"ZIP\" (" + //
                "\"_id\" INTEGER PRIMARY KEY ," + // 0: id
                "\"ZIP_CODE\" TEXT," + // 1: zipCode
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"ZIP\"";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, Zip entity) {
        stmt.clearBindings();
        ...
        if (zipCode != null) {
            stmt.bindString(2, zipCode);
        }
        stmt.bindLong(3, entity.getCurrent() ? 1L: 0L);
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(Zip entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
